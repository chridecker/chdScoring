...
if($_GET['action'] == "start"){
	mysqli_query($link,"UPDATE wettkampf_leitung wl SET wl.start_time = (CURTIME()+1) WHERE status = 1 AND teilnehmer = ".$res_teilnehmer->teilnehmer." AND durchgang = ".$res_teilnehmer->durchgang);
}
