...
//Norm Prelim Rounds to 1000
$res_max_prom = mysqli_fetch_object(mysqli_query($link,"SELECT max(prom) as max_prom FROM bewerb".$bewerb." WHERE durchgang = 1"));
mysqli_query($link,"UPDATE bewerb".$bewerb." SET prom = prom / ".$res_max_prom->max_prom." * 1000 WHERE durchgang = 1");
