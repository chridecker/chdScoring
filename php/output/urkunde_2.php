...
else $logo = $result_config->gruppe_id;
...
if($result_teilnehmer = mysqli_query($link,$query_teilnehmer)){
	...
	<table align='center'>
		<tr><td><br></td></tr>
		<tr><td colspan="3" class="logo"><br></td></tr>
		<tr class="headline"><th colspan='3'><br></th></tr>
		<tr><td><br></td></tr>
		<tr><td><br></td></tr>
		<tr><td><br></td></tr>
		<tr><td><br></td></tr>
		...
		<tr class="ergebnis"><th colspan="3" class="punkte">errang mit <?php echo number_format($teilnehmer->gesamt,2,",","");?>
        &permil; Punkten</th></tr>
		<tr class="ergebnis"><th colspan="3" class="platz"><i>den</i> <?php echo $rank;?>. Platz</th></tr>
		<tr class="bild"><td colspan="3" class="gruppenbild"><img height="280" src="../operations/load_image.php?id=<?php echo $logo; ?>&db=<?php echo $database;?>"></td></tr>
		<tr><td><br></td></tr>
