...
<th>Rank</th><th>Name</th><th>Nation</th><th>FAI-License</th>
<?php
...
while($teilnehmer = mysqli_fetch_object($result_teilnehmer)){
	...
	?>
	<tr class="<?php if($count % 2 == 0) echo "gerade";else echo "ungerade";?>" <?php if($count == $final_teilnehmer) echo "style='border-bottom:solid;'";?>>
